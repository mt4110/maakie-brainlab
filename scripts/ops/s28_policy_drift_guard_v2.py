...
Goal:
- Detect drift across S28 operation contracts.
...
DEFAULT_OUT_DIR = "docs/evidence/s28-05"
DEFAULT_BASELINE = "policy_drift_baseline_v2.json"
...
def build_markdown(payload: Dict[str, Any]) -> str:
    ...
    lines: List[str] = []
    lines.append("# S28-05 Policy Drift Guard v2 (Latest)")
    lines.append("")
...
def main() -> int:
    ...
    run_dir, meta, events = make_run_context(repo_root, tool="s28-policy-drift-guard-v2", obs_root=args.obs_root)
    ...
    payload: Dict[str, Any] = {
        "schema_version": "s28-policy-drift-guard-v2",
        ...
        "artifact_names": {
            ...
            "md": "policy_drift_guard_v2_latest.md",
            "baseline": str(args.baseline_file),
        },
    }

    out_json = out_dir / "policy_drift_guard_v2_latest.json"
    out_md = out_dir / "policy_drift_guard_v2_latest.md"
