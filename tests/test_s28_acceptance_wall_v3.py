...
def _load_module():
    ...
    path = root / "scripts" / "ops" / "s28_acceptance_wall_v3.py"
    spec = importlib.util.spec_from_file_location("s28_acceptance_wall_v3", path)
...
class S28AcceptanceWallV3Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.m = _load_module()
