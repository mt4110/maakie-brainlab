...
def _load_module():
    ...
    path = root / "scripts" / "ops" / "s27_policy_drift_guard.py"
    spec = importlib.util.spec_from_file_location("s27_policy_drift_guard", path)
...
class S27PolicyDriftGuardTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.m = _load_module()
