...
- scripts/ops/gh_ruleset_doctor.sh
  ...
  - “未観測” が出た場合のみ、直近Nコミットを追加観測して誤検知を減らす（軽量）
...
- docs/ops/RULESET_GUARD.md
  - 運用手順（いつ doctor を回すか / 何を見てどう直すか）
- **ops/s22-15_ops_pack.sh (Addendum Pack 4-9の実装)**
